...
public interface IBuildingZoneService
{
	...
	BuildingZone GetZoneByDistance(int distance);
}

public class BuildingZoneService : IBuildingZoneService
{
	private readonly BuildingZone _centralZone = new("buildings-central", 10, 10, 4 * 16);
	private readonly BuildingZone _urbanZone = new("buildings-urban", 6, 6, 9 * 16);
	...
	public BuildingZone GetZoneByDistance(int distance)
	{
